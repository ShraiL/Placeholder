...
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'{EntityNamePlural}Database')
BEGIN
    CREATE DATABASE {EntityNamePlural}Database;
END
GO

USE {EntityNamePlural}Database;
GO
